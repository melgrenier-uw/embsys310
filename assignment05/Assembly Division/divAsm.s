/*******************************************************************************
File name       : divAsm.s
Description     : Assembly language function for dividing and argument by 2
*******************************************************************************/
...
Description     : Calls C code to print a string; 
                  Takes an input argument, divides it by 2, and returns the result
...
divAsm
    ...
    MOV R1, #2          // R1 = 2
    UDIV R0, R0, R1      // R0 = R0 / 2 (unsigned division since input argument is unsigned) 
